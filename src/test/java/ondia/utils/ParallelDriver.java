...
import static ondia.utils.ConfigReader.getProperty;
...
public class ParallelDriver {
    ...
    public static WebDriver getDriver() {
        ...
        if (driverPool.get() == null) {
            ...
            //eğer maven komutuyla herhangi bir bworser yollarsak ilk onu çalıştırır
            //herhangi bir browser yoksa direk config.properties i alır
